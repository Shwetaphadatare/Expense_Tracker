  ...
  return (
    <View className="flex-1 bg-white px-6 pt-16 py-4">
      ...
      <View className="mb-12">
        <Text className="text-start text-4xl font-bold text-slate-900">Understand Your</Text>

        <Text className="text-start text-4xl font-bold text-emerald-700">Spending</Text>

        <Text className="mt-4 text-start text-lg leading-7 text-gray-600">
          Smart insights help you analyze and manage your habits
        </Text>
      </View>
